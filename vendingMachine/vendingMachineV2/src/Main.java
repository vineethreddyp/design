...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            vineethAdmin.getVendingMachine().printCoinState(); // this line for debug purpose only. this can be commented
    ...
    private static VendingMachineImpl generateVendingMachine() {
        InventoryManagement<Product> productManagement = new ProductManagementImpl();
        VendingMachineImpl vendingMachine = new VendingMachineImpl("Vineeth's vending machine",productManagement);
        ...
        vineeth.addChangeInsideMachine(Coin.Five, 5);
